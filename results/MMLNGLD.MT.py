...
max_worker = 1 # psutil.cpu_count() - 4
...
################################
        ...
        plt.legend()
        plt.savefig(f"out.mmlngld.{file_name}.{attribute_key}.mt.png", bbox_inches="tight")
        tg_send_file(f"out.mmlngld.{file_name}.{attribute_key}.mt.png")
